  ...
  return (
    ...
    >
      <div className="h-[50%] relative w-full">
        <Image src={props.consumableImage} alt="name" priority={true} className="object-cover rounded-t-xl" fill />
      </div>
      <div className="flex flex-col items-start justify-between p-4 grow gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-1">
            <div className="relative h-5 w-5 rounded-full border border-black">
              <Image src={props.userImage} fill className="object-cover rounded-full" alt={props.user} />
            </div>
          ...
          <div className="flex gap-2 ">
            <LocationSign />
            <p className="text-xs truncate max-w-24 text-gray-500">{props.district}</p>
          </div>
        </div>

        <div className="flex items-center justify-between w-full">
          <p className=" font-semibold text-3xl text-primary-blue">{props.consumable}</p>
        ...
        <div className="flex justify-between w-full items-start">
          ...
          <div className="text-sm flex flex-col items-end">
            {props.quantity} Kg <span className="text-xs font-extralight">available</span>
          </div>
        </div>
      </div>
    </div>
